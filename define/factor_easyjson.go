...
func easyjson5155cd71DecodeGithubComZhj0811FabricDefine(in *jlexer.Lexer, out *Factory) {
...
func easyjson5155cd71EncodeGithubComZhj0811FabricDefine(out *jwriter.Writer, in Factory) {
	out.RawByte('{')
	first := true
	_ = first
	{
